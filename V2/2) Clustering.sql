...
SELECT system$clustering_depth('MS_FINSIGHTS_XXX.COREBANKING.TRANSACTIONS','(TRANSACTION_DATE)');
...
--LET US CLONE THE ORIGINAL TABLE AND CLUSTER IT
CREATE TABLE TRANSACTIONS CLONE MS_FINSIGHTS_XXX.COREBANKING.TRANSACTIONS;

ALTER TABLE TRANSACTIONS
    CLUSTER BY (TRANSACTION_DATE);


---LET US INVESTIGATE THE DISTRIBUTION OF DATA IN MICROPARTITIONS
select system$clustering_information('MS_FINSIGHTS_XXX.PUBLIC.TRANSACTIONS','(TRANSACTION_DATE)');


select system$clustering_depth('MS_FINSIGHTS_XXX.PUBLIC.TRANSACTIONS','(TRANSACTION_DATE)');
