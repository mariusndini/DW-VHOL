...
/*#########################################################
    ...
    - BEST PRACTICE: Use an isolated warehouse for dynamic tables so resources are not contending
*/

CREATE WAREHOUSE IF NOT EXISTS HOL_WH_XL_DT_XXX
...
SELECT * 
FROM COREBANKING.TRANSACTION_REPORT
...
SELECT * 
FROM COREBANKING.FULL_CUSTOMER 
WHERE CUSTOMER_ID = '402000';
